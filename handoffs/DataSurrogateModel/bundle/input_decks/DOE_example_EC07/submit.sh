...
#BSUB -P 2026
#BSUB -W 4:00
#BSUB -cwd "/home/health/fd2997/cylinder_doe/runs/EC07"
#BSUB -R "select[defined(aspherix_solver)] rusage[aspherix_solver=16:duration=5]"
#BSUB -app aspherix
#BSUB -o /home/health/fd2997/cylinder_doe/runs/EC07/lsf_%J.o
#BSUB -e /home/health/fd2997/cylinder_doe/runs/EC07/lsf_%J.e
...
cd "/home/health/fd2997/cylinder_doe/runs/EC07" || exit 1
